...
def load_traces():
	#Import our traces
	traces = np.load('traces/trainingTraces/xmega1B/xmega1B_EM_training_traces.npy')[:,57:153] 
	labels = np.load('traces/trainingTraces/xmega1B/xmega1B_EM_training_labels.npy')
	
	#Trace and label indexing
	delimitedTraces = traces[:250000,:]
	delimitedLabels = labels[:250000]
